========================================================================
    APLICACIÓN DE CONSOLA: VideoRecorder 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación VideoRecorder.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación VideoRecorder.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado VideoRecorder.pch y un archivo de tipos 
